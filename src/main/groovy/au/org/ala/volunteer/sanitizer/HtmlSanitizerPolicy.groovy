...
class HtmlSanitizerPolicy {
    ...
    private static final Pattern LINK_TARGET = Pattern.compile("(?i)_blank|_self|_parent")
     ...
     * via {@link org.owasp.html.PolicyFactory#apply}.
     */
    public static final PolicyFactory POLICY_DEFINITION = new HtmlPolicyBuilder()
            ...
            .onElements("a")
            .allowAttributes("target").matching(LINK_TARGET).onElements("a")
