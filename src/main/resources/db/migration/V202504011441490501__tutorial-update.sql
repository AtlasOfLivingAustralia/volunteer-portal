...
CREATE TABLE IF NOT EXISTS tutorial (
    ...
    tutorial_name varchar(60) NOT NULL,
...
COMMENT ON COLUMN tutorial.date_updated IS 'Datetime record was last updated';
...
COMMENT ON COLUMN tutorial.created_by IS 'ID of the user who created the tutorial record';
COMMENT ON COLUMN tutorial.updated_by IS 'ID of the user who last updated the tutorial record';
