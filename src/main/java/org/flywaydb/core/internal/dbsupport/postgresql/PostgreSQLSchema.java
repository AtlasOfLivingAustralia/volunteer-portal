 ...
 *
 * Cause Flyway can't be customised, this is a copy of the 4.2.0 PostgreSQLSchema source
 * with patches to support PostgreSQL 11
 *
 * TODO Remove after Grails 4 upgrade
 */
