...
//        }
    ...
    @Cacheable(value = 'StatsHourlyContribution', key = { "${(institution ? institution.id : "-1")}-${(startDate ? startDate.getTime() : "-1")}-${(endDate ? endDate.getTime() : "-1")}" })
    ...
    @Cacheable(value = 'StatsTranscriptionTime', key = { "${(institution ? institution.id.toString() : '-1')}-${(startDate ? startDate.getTime() : '-1')}-${(endDate ? endDate.getTime() : '-1')}" })
