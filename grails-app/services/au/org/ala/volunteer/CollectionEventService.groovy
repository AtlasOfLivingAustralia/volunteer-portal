...
class CollectionEventService {
    ...
    public CollectionEventImportResult importEvents(String institutionCode, MultipartFile file) {

        def result = new CollectionEventImportResult(success: false, message: '');
...
class CollectionEventImportResult {
    boolean success
    String message
    int rowsProcessed
    int rowsSkipped
