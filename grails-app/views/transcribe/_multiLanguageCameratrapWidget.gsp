...
<div class="itemgrid">
    ...
    <g:else>
        ...
        <div class="thumbnail ct-thumbnail"
             data-image-key="${piItem.key}"
             data-image-select-key="${piItem.value.imageIds}"
             data-image-select-value="${piItem.value.name[LocaleContextHolder.getLocale().getLanguage()]}"
             data-tags="${piItem.value.tags}"
             data-day-images="${piItem.value.dayImageIds}"
             data-night-images="${piItem.value.nightImageIds}"
             data-popularity="${piItem.value.popularity}"
            ...
            <div class="ct-caption-table">
                <div class="ct-caption-cell">
                    <div class="ct-caption dotdotdot" title="${piItem.value.name[LocaleContextHolder.getLocale().getLanguage()]}">${piItem.value.name[LocaleContextHolder.getLocale().getLanguage()]}</div>
                </div>
            </div>
        </div>
    </div></g:each>
