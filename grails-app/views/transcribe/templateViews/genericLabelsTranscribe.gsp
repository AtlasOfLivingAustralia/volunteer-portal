...
<g:applyLayout name="digivol-task" model="${pageScope.variables}">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>        <title><cl:pageTitle title="${(validator) ? message(code: 'transcribe.templateViews.all.validate') : message(code: 'transcribe.templateViews.all.expedition')} ${taskInstance?.project?.i18nName}" /></title>
    </head>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div id="taskMetadata">
                        ...
                        <div class="transcribeSectionHeaderLabel"><g:message code="transcribe.templateViews.genericLabelsTranscribe.specimen_information"/></div>
                        <ul>
                            <li><span class="metaDataLabel"><g:message code="transcribe.templateViews.genericLabelsTranscribe.institution"/></span> <span
                                    id="institutionCode">${recordValues?.get(0)?.institutionCode}</span></li>
                            <li><span class="metaDataLabel"><g:message code="transcribe.templateViews.genericLabelsTranscribe.project"/></span> ${taskInstance?.project?.i18nName}</li>
        ...
        <div class="panel-body">
            <div class="row transcribeSectionHeader">
                <div class="col-md-12">
                    ...
                    <a style="float:right" class="closeSectionLink" href="#">${message(code: 'transcribe.templateViews.all.interpreted_location')}</a>
                </div>
            </div>
