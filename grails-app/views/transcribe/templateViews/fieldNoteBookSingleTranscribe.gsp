...
%{--                            </a>--}%
                            <button class="btn btn-outline-secondary btn-mini float-end textAreaResizeButton" style="margin-bottom: 3px">
...
%{--                            <a href="#" class="btn btn-outline-secondary btn-xs fieldHelp"--}%
%{--                               title='${allTextField?.helpText ?: "Transcribe all text as it appears on the page"}' placement="left">--}%
%{--                                <i class="fa fa-question help-container"></i>--}%
%{--                            </a>--}%
                            <button class="btn btn-outline-secondary btn-mini float-end textAreaResizeButton" style="margin-bottom: 3px">
                                <i class="fa fa-expand"></i>
    ...
    $(document).ready(function () {
        ...
        $(".textAreaResizeButton").click(function (e) {
            ...
            if (page.hasClass("col-md-6")) {
                ...
                page.find(".textAreaResizeButton").html('<span class="fa fa-compress"></span>');
                ...
                otherPage.addClass(shrunkClass);
                page.find(".textAreaResizeButton").html('<span class="fa fa-compress"></span>');
                otherPage.find(".textAreaResizeButton").html('<span class="fa fa-expand"></span>');
            } else {
                ...
                page.find(".textAreaResizeButton").html('<span class="fa fa-expand"></span>');
                otherPage.find(".textAreaResizeButton").html('<span class="fa fa-expand"></span>');
