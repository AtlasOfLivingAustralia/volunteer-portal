<div class="latLongWidget ${cssClass}" targetField="${field.fieldType}">
    <div class="row-fluid control-group">
        <div class="span12">
            <div class="span4">
                <g:select tabindex="${tabindex}" class="span12 latLongFormatSelector" optionKey="value"
            ...
            <div class="latLongWidget_DMS span8">
                <div class="span3">
                    <g:textField tabindex="${tabindex}" name="${field.fieldType}.degrees" placeholder="D"
                                 class="span12 degrees" value="" validationRule="${field.validationRule}"/>
                </div>

                <div class="span3">
                    <g:textField tabindex="${tabindex}" name="${field.fieldType}.minutes" placeholder="M"
                                 class="span12 minutes" value="" validationRule="${field.validationRule}"/>
                </div>

                <div class="span2">
                    <g:textField tabindex="${tabindex}" name="${field.fieldType}.seconds" placeholder="S"
                                 class="span12 seconds" value="" validationRule="${field.validationRule}"/>
                </div>
                ...
                <div class="span4">
                    ...
                    <g:select tabindex="${tabindex}" class="span12 direction" name="${field.fieldType}.direction"
            ...
            <div class="latLongWidget_DD span8" style="display: none">
                <g:textField tabindex="${tabindex}" name="${field.fieldType}.decimalDegrees"
                             class="span12 decimalDegrees" placeholder="Decimal" value=""
