                ...
                <table style="width: 100%;">
                    <thead>
                        <tr style="width: 950px">
                            <th colspan="4">
                                <h3>3. Interpreted Location</h3>&nbsp;<button id="geolocate" href="#mapWidgets" title="Show geolocate tools popup">Use mapping tool</button>&ndash;
                                Use the mapping tool before attempting to enter values manually
                                <a style="float:right" class="closeSection" href="#">Shrink</a>
                            </th></tr>
                    </thead>
                    <tbody>
