    ...
    <div class="row-fluid">
        ...
        <div class="span4">
            ...
            <div class="well well-small">
                ...
                <div class="span12" style="margin-top: 5px">Verbatim Locality <a href='#' class='fieldHelp'
                                                                                 title='Enter (or cut and paste from the box above) the locality information into this box'><span
                            class='help-container'>&nbsp;</span></a></div>
                <textarea class="span12" name="recordValues.0.verbatimLocality" cols="38" rows="2"
        ...
        <div class="transcribeSectionBody">
                        ...
                        <g:each in="${0..3}" var="idx">
                            <div class="span3">
                                <input type="text" name="recordValues.${idx}.recordedBy" maxlength="200"
                                       class="span12 recordedBy autocomplete" id="recordValues.${idx}.recordedBy"
            ...
            <div class="row-fluid">
                <div class="span12">
                    <g:renderFieldBootstrap fieldType="${DarwinCoreField.eventDate}" recordValues="${recordValues}"
                                            task="${taskInstance}" labelClass="span2" valueClass="span3"/>
                </div>
            </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span6 collectionEventSection">
                    <strong>a.</strong>&nbsp; <button type="button" class="btn"
            ...
            <div class="existingLocalitySection">
                ...
                <div class="row-fluid">
                    <div class="span6 offset2">
                        <strong>i.</strong>&nbsp;<button type="button" class="btn"
                ...
                <div class="row-fluid">
                    <div class="span6">
                        <g:renderFieldBootstrap fieldType="${DarwinCoreField.locality}" recordValues="${recordValues}"
                                                task="${taskInstance}" labelClass="span4" valueClass="span8"/>
                    </div>
