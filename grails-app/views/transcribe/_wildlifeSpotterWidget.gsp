<div class="itemgrid">%{--
    ...
    --}%<g:each in="${imageInfos}" var="piItem" status="st"><div class="griditem bvpBadge"
                                                                           data-item-index="${st}">
        <div class="thumbnail ct-thumbnail ws-selector" aria-selected="false" data-image-select-key="${st}" title="${g.message(code: 'wildlifespotter.widget.badge.title', args: [piItem.vernacularName])}">
