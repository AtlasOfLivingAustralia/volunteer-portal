...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            td .decimalLatitude, td .decimalLongitude {
                width: 150px
            }
    ...
    <body class="sublevel sub-site volunteerportal">
            ...
            <div class="inner">
                <nav id="breadcrumb">
                    <ol>
                        ...
                        <li><a href="${createLink(controller: 'project', action: 'list')}"><g:message code="default.projects.label"/></a>
                        </li>
        ...
        <g:if test="${taskInstance}">
            ...
            <div id="taskMetadata">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding-bottom: 0px; margin-top:0px" colspan="2">
                                <g:textArea name="recordValues.0.occurrenceRemarks" value="${recordValues?.get(0)?.occurrenceRemarks}" id="recordValues.0.occurrenceRemarks" rows="8" cols="42"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <tr class="prop">
                            ...
                            <td class="value" colspan="3">
                                <g:each in="${0..3}" var="idx">
                                    <input style="width:170px" type="text" name="recordValues.${idx}.recordedBy" maxlength="200" class="recordedBy noAutoComplete ac_input" id="recordValues.${idx}.recordedBy" value="${recordValues[idx]?.recordedBy?.encodeAsHTML()}"/>&nbsp;
                ...
                <table style="width:100%; margin-top: 0">
                    <tbody>
                        <g:each in="${TemplateField.findAllByCategoryAndTemplate(FieldCategory.collectionEvent, template, [sort: 'displayOrder'])}" var="field">
                            <g:fieldFromTemplateField rowClass="columnLayout" templateField="${field}" recordValues="${recordValues}"/>
                        </g:each>
                    </tbody>
                </table>
            </div>

            <g:set var="sectionNumber" value="${new Integer(3)}" />
            ...
            <g:set var="identificationFields" value="${TemplateField.findAllByCategoryAndTemplate(FieldCategory.identification, template, [sort: 'displayOrder'])}" />

            <div id="transcribeFields">

                <g:if test="${miscFields}">
                ...
                <g:if test="${identificationFields}">
                    <table style="width: 100%">
                        <thead>
                            <tr style="width:950px">
                                <th style="width:950px">
                        ...
                        <tbody>
                            <g:each in="${identificationFields}" var="field">
                                <g:fieldFromTemplateField templateField="${field}" recordValues="${recordValues}"/>
                            </g:each>
                        </tbody>
                    </table>
