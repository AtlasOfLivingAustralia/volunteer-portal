        ...
        <div class="row-fluid">
            ...
            <div id="rightPage" class="span6 page">
                <div class="well well-small">
                    ...
                    <button class="btn btn-mini pull-right textAreaResizeButton" style="margin-bottom: 3px"><i class="icon icon-resize-full"></i></button>
                    <g:textArea class="span12 occurrenceRemarks" name="recordValues.1.occurrenceRemarks" value="${recordValues?.get(1)?.occurrenceRemarks}" id="recordValues.1.occurrenceRemarks" rows="${numberOfTextRows}" cols="42"/>
                </div>
            </div>
        </div>
    </g:if>
