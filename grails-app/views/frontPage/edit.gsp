                ...
                <table style="width:100%">
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="projectOfTheDay"><g:message code="frontPage.projectOfTheDay.label"
                                                                    default="Project of the day"/></label>
                        </td>
                        <td valign="top"
                            class="value ${hasErrors(bean: frontPage, field: 'projectOfTheDay', 'errors')}">
                            <g:select name="projectOfTheDay" from="${au.org.ala.volunteer.Project.listOrderByName()}"
                            ...
                            <g:link class="btn btn-warning" action="edit" controller="project"
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="useGlobalNewsItem"><g:message code="frontPage.useGlobalNewsItem.label"
                                                                      default="Use global news item"/></label>
                        </td>
                        <td valign="top"
                            class="value ${hasErrors(bean: frontPage, field: 'useGlobalNewsItem', 'errors')}">
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="newsTitle"><g:message code="frontPage.newsTitle.label"
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="newsBody"><g:message code="frontPage.newsBody.label"
                                                             default="News text"/></label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean: frontPage, field: 'newsBody', 'errors')}">
                            <g:textArea class="input-xxlarge" cols="50" rows="4" name="newsBody"
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="newsCreated"><g:message code="frontPage.newsCreated.label"
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="systemMessage"><g:message code="frontPage.systemMessage.label"
                        ...
                        <td valign="top" class="value ${hasErrors(bean: frontPage, field: 'systemMessage', 'errors')}">
                            <g:textArea class="input-xxlarge" cols="50" rows="4" name="systemMessage"
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="showAchievements"><g:message code="frontPage.showAchievements.label"
                                                                     default="Show achievements on User stats page"/></label>
                        </td>
                        <td valign="top"
                            class="value ${hasErrors(bean: frontPage, field: 'showAchievements', 'errors')}">
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="enableTaskComments"><g:message code="frontPage.enableTaskComments.label"
                                                                       default="Enable task commenting"/></label>
                        </td>
                        <td valign="top"
                            class="value ${hasErrors(bean: frontPage, field: 'enableTaskComments', 'errors')}">
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="enableForum"><g:message code="frontPage.enableForum.label"
