...
<section id="expedition-feature">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h3><a href="${createLink(controller: 'project', id: frontPage.projectOfTheDay?.id, action: 'index')}">${frontPage.projectOfTheDay?.featuredLabel}</a>
                </h3>
                <a class="badge"><span class="glyphicon glyphicon-tag icon-flipped"></span>Field notes</a><a
                    class="badge"><span
                    ...
                    <g:each in="${featuredProjects}" var="featuredProject">
                        <div class="col-sm-12 col-md-6">
                            <div class="thumbnail">
                                ...
                                <a href="${createLink(controller: 'project', id: featuredProject.project?.id, action: 'index')}"><img
                                        src="${featuredProject.project?.featuredImage}" class="img-responsive"></a>
            ...
            <div class="col-sm-4">
                ...
                <div class="panel panel-default leaderboard">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <tr>
                            <th scope="row"><a href="#"><img src="https://randomuser.me/api/portraits/med/women/35.jpg"
                                                             class="img-circle"></a></th>
                        ...
                        <tbody>
                        <tr>
                            <th scope="row"><a href="#"><img src="https://randomuser.me/api/portraits/med/women/12.jpg"
                                                             class="img-circle"></a></th>
                        ...
                        <tbody>
                        <tr>
                            <th scope="row"><a href="#"><img src="https://randomuser.me/api/portraits/med/women/19.jpg"
                                                             class="img-circle"></a></th>
                        ...
                        <tbody>
                        <tr>
                            <th scope="row"><a href="#"><img src="https://randomuser.me/api/portraits/med/women/22.jpg"
                                                             class="img-circle"></a></th>
                            <th><a href="#">Rachel Lee</a></th>
                ...
                <ul class="media-list">
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="transcribed-thumbs">
                                <img src="http://placehold.it/40x40/ccc"> <img src="http://placehold.it/40x40/ccc"> <img
                                    src="http://placehold.it/40x40/ccc"> <img src="http://placehold.it/40x40/ccc">  <img
                                    src="http://placehold.it/40x40/ccc"> <a href="#"><span>+2</span>More</a>
                            </div>
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="transcribed-thumbs">
                                <img src="http://placehold.it/40x40/ccc"> <img src="http://placehold.it/40x40/ccc"> <img
                                    src="http://placehold.it/40x40/ccc">
                            </div>
                            <a class="btn btn-default btn-xs join" href="#" role="button">Join expedition »</a>
                        </div>
