  ...
  <g:form action="save">
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          <td valign="top" class="name">
            <label for="filePathToThumbnail"><g:message code="multimedia.filePathToThumbnail.label" default="File Path To Thumbnail"/></label>
          </td>
          <td valign="top" class="value ${hasErrors(bean: multimediaInstance, field: 'filePathToThumbnail', 'errors')}">
            <g:textField name="filePathToThumbnail" maxlength="200" value="${multimediaInstance?.filePathToThumbnail}"/>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: multimediaInstance, field: 'record', 'errors')}">
            <g:select name="record.id" from="${au.org.ala.volunteer.Record.list()}" optionKey="id" value="${multimediaInstance?.record?.id}" noSelection="['null': '']"/>
          </td>
        </tr>
