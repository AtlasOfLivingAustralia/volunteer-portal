        ...
        <div class="thumbnail">
            ...
            <div class="${projectSummary.project?.inactive ? 'expedition-inactive' : ''}">
                <g:link controller="project" action="index" class="thumbImg" id="${projectSummary.project?.id}">
                    <img class="img-responsive cropme" src="" realsrc="${projectSummary.project?.featuredImage}" style="width: 100%; height: 236px;" data-error-url="${createLink(file: '/banners/default-expedition-large.jpg')}"/>
                </g:link>
