...
<div class="control-group">
    <label class="control-label" for="jumpNTasks"><g:message code="template.cameratrap.jump.label"
...
<div class="control-group">
    <label class="control-label" for="animalsPicklistId"><g:message code="template.cameratrap.animals.label"
                                                                    default="All Animals Picklist"/></label>

    <div class="controls">
        <g:select from="${picklists}" name="animalsPicklistId" optionKey="id" optionValue="uiLabel"
                  class="input-xlarge"/> <button type="button" class="btn btn-primary btn-view-ct-picklist"><i
