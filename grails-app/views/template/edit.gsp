    ...
    <div class="span12">
        ...
        <g:form method="post" class="form-horizontal">
            ...
            <div class="control-group ${hasErrors(bean: templateInstance, field: 'viewName', 'error')}">
                <label class="control-label" for="viewName"><g:message code="template.viewName.label"
                                                                       default="View Name"/></label>
            ...
            <div id="row-view-params-json"
                 class="control-group ${hasErrors(bean: templateInstance, field: 'viewParams', 'error')}">
                <label class="control-label" for="viewParamsJSON"><g:message code="template.viewparams.label"
                                                                             default="Template View Parameters:"/></label>

                <div class="controls">
                    <g:textArea name="viewParamsJSON" rows="4" cols="40"
                                value="${templateInstance.viewParams as grails.converters.JSON}"></g:textArea>
                </div>
            </div>

            <div id="row-view-params-json" class="control-group">
                <label class="control-label" for="project"><g:message code="template.project.label"
