...
<div class="row">
    <div id="content" class="span12">
        <div class="alert alert-info">
            ...
            <cl:ifAdmin>
                <a href="${createLink(controller: 'picklist', action: 'manage', id: picklistInstance.id)}"
                   class="btn pull-right">Manage Picklist Items</a>
            </cl:ifAdmin>
        </div>
            ...
            <g:each in="${picklistItemInstanceList}" status="i" var="picklistItemInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    <td><g:link controller="picklistItem" action="show"
                                id="${picklistItemInstance.id}">${fieldValue(bean: picklistItemInstance, field: "id")}</g:link></td>
