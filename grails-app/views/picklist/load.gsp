      ...
      <g:form method="post" action="upload" controller="picklist">
        <div class="dialog">
          <table>
            ...
            <tr class="prop">
              <td valign="top" class="name">
                <label for="picklist"><g:message code="picklist.paste.here.label" default="Paste list here"/></label>
              </td>
              <td valign="top" class="value">
        ...
        <div class="buttons">
          <span class="button"><g:actionSubmit class="submit" action="upload" value="${message(code: 'default.button.submit.label', default: 'Submit')}"/></span>
