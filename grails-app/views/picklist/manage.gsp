        ...
        <g:form method="post">
            ...
            <div id="picklist-form" class="form-horizontal">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <g:select name="picklistId" from="${picklistInstanceList}" optionKey="id" optionValue="uiLabel"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <g:actionSubmit class="btn" name="download.picklist"
                                        value="${message(code: 'download.picklist.label', default: 'Download items as CSV')}"
                                        action="download"/>
                        <g:actionSubmit class="btn" name="load.textarea"
            ...
            <p>
                <g:message code="picklist.paste.here.label"
                           default="Paste csv list here. Each line should take the format '&lt;value&gt;'[,&lt;optional key&gt;]"/>
            </p>
            ...
            <a href="#picklistModal" id="upload-picklist-file" role="button" class="btn"
               data-toggle="modal">${message(code: 'upload.bulkpicklist.label', default: 'Upload CSV File')}</a>
            <button id="sort-button" type="button" class="btn" title="Sort list"><i class="icon-arrow-down"></i>
            </button>
            <button id="reverse-button" type="button" class="btn" title="Reverse list order"><i
...
<div id="picklistModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="picklistModalLabel"
     aria-hidden="true">
    ...
    <g:uploadForm class="form-horizontal" action="uploadCsvFile">
        ...
        <div class="modal-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <g:select id="upPicklistId" name="picklistId" from="${picklistInstanceList}" optionKey="id"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <g:select id="upInstitutionCode" name="institutionCode" from="${collectionCodes}"
