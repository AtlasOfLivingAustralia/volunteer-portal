<%@ page import="org.codehaus.groovy.grails.commons.ConfigurationHolder; au.org.ala.volunteer.Field" %>
<html>
    <head>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="field.transcribedByUserId.label" default="Transcribed By User Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="field.validatedByUserId.label" default="Validated By User Id" /></td>
