...
<body>
    ...
    <content tag="adminButtonBar">
        <a class="btn btn-primary" href="${createLink(controller:'newsItem', action:'create', params:['institution.id': institutionInstance.id])}"><i class="icon-plus icon-white"></i> Add news item</a>
    </content>
