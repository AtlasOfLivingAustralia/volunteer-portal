...
<html>
    ...
    <body class="" style="overflow-x: hidden; overflow-y: scroll;">
        <div class="inner">
            ...
            <p>
                The <g:message code="default.application.name" /> Forum makes use of a text markup technology called <strong>MarkDown</strong> that allows you to format your forum message posts to include font effects (such as <b>bolding</b> and <i>italics</i>), headings, lists and others.
            </p>
            <p>
