...
<body>
    <cl:headerContent title="Transcribing Specimen Labels">
        <%
            pageScope.crumbs = [
...
<t:ul>
    <li><b>Find existing collection event</b>: When choosing a collection event make sure collector(s), date(s) and place match. If for example the date differs by a day do not choose this collection event.
    </li>
    <li><b>Find existing locality</b>: If the initial search doesn’t find an existing locality try expanding abbreviations, inserting or removing spaces and commas or simplifying the locality description, eg by deleting the state. Example If “Broome,  WA” doesn’t get a result try “Broome” or “Broome Western Australia”>
    </li>
    <li><b>Use Mapping Tool</b>: Interpret the locality information in the labels into a form that is most likely to result in as accurate geographic coordinates as possible. Expand abbreviations, and remove unnecessary words and punctuation. E.g. &quot;Scott Is. Tweed R. near Tumbulgum NSW&quot; would become &quot;Scott Island, Tweed River, Tumbulgum, NSW&quot;. If the map doesn’t come up with the correct location then try breaking the description up into single words to see if the map tool can find a location then. Where the map tool cannot find a location simply fill in the State/territory and Country fields. A summary of the abbreviations you may encounter with specimen labels is listed below.
    </li>
...
<table border="1">
    <tbody>
        <tr><td><strong>Abbreviation</strong></td><td><strong>Enter as</strong></td><td><strong>comments</strong></td>
        </tr>
        ...
        <tr><td>F.R.</td><td>Fauna Reserve, Flora Reserve, Forest Reserve</td><td>find out correct status before entering</td>
        </tr>
        ...
        <tr><td>NP, Nat Pk</td><td>National Park or Nature Park</td><td>find out correct status before entering</td>
        </tr>
        ...
        <tr><td>Res.</td><td>Reserve or Reservation or Reservoir</td><td>find out correct status before entering</td>
        </tr>
        ...
        <tr><td>St</td><td>St (when =&quot;Saint&quot; in a place or persons name) or State or Street or Station</td><td>find out correct status before entering</td>
        </tr>
        ...
        <tr><td>Cult.</td><td>Cultured</td><td>eg. bred, sometimes used in place of site on the understanding that the locality where the specimen came from is not really where the species occurs in the wild</td>
        </tr>
    </tbody>
</table>
