                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr><td>collevent_irn</td><td>Collection Event internal record number. Institution specific identifier for the event</td></tr>
                                        ...
                                        <tr><td>ColDateVisitedFrom</td><td>The date of the collection event in the format YYYY-MM-DD (YYYY-MM if day is missing, or YYYY if both day and month are missing)</td></tr>
                                        <tr><td>site_irn</td><td>The internal record number for the location of the event. Institution specific identifier for the site.</td></tr>
                                    </table>
                                </td>
                            </tr>
                        </table>
