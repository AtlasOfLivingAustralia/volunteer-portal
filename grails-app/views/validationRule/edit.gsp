    ...
    <div class="span12">
        ...
        <g:form method="post">
            ...
            <table class="table">
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="validationRule.description.label"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="validationType"><g:message code="validationRule.validationType.label"
                                                               default="Validation Type"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: rule, field: 'validationType', 'errors')}">
                        <g:select name="validationType" from="${au.org.ala.volunteer.ValidationType.values()}"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="regularExpression"><g:message code="validationRule.regularExpression.label"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="testEmptyValues"><g:message code="validationRule.testEmptyValues.label"
                                                                default="Test empty/blank values"/></label>
                    </td>
