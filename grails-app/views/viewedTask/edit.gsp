                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: viewedTaskInstance, field: 'task', 'errors')}">
                                    <g:select name="task.id" from="${au.org.ala.volunteer.Task.list()}" optionKey="id" value="${viewedTaskInstance?.task?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="numberOfViews"><g:message code="viewedTask.numberOfViews.label" default="Number Of Views" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: viewedTaskInstance, field: 'numberOfViews', 'errors')}">
                                    <g:textField name="numberOfViews" value="${fieldValue(bean: viewedTaskInstance, field: 'numberOfViews')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: viewedTaskInstance, field: 'lastView', 'errors')}">
                                    <g:textField name="lastView" value="${fieldValue(bean: viewedTaskInstance, field: 'lastView')}" />
                                </td>
                            </tr>
