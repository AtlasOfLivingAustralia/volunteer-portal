                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="task" action="show" id="${viewedTaskInstance?.task?.id}">${viewedTaskInstance?.task?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="viewedTask.numberOfViews.label" default="Number Of Views" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="viewedTask.dateCreated.label" default="Date Created" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="viewedTask.lastUpdated.label" default="Last Updated" /></td>
