                    ...
                    <cl:ifSiteAdmin>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary bs3" title="A summary of recent user activity"
                                   href="${createLink(controller: 'admin', action: 'currentUsers')}">Current users</a>
                                </cl:ifSiteAdmin>
                                <a class="btn btn-primary bs3" title="List of all expeditions and their statistics"
