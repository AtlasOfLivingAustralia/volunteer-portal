            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed table-condensed admin-table">
                        ...
                        <tr>
                            <td><a class="btn btn-primary" href="${createLink(controller: 'stats', action: 'index')}">Stats</a></td>
                        ...
                        <tr>
                            <td><a class="btn btn-primary" href="${createLink(controller: 'admin', action: 'tools')}">Tools</a></td>
                            <td>Tools</td>
                        </tr>
                        <tr>
                            <td><a class="btn btn-primary"
                        ...
                        <tr>
                            <td>Admin reports</td>
                            <td>
                                <a class="btn btn-primary" title="Display a list of email address for all volunteers"
                                   href="${createLink(controller: 'admin', action: 'mailingList')}">Global mailing List</a>
                                <a class="btn btn-primary" title="Users and their various counts and last activity etc..."
                                   href="${createLink(controller: 'ajax', action: 'userReport', params: [wt: 'csv'])}">User report</a>
                                <a class="btn btn-primary" title="A summary of recent user activity"
                                   href="${createLink(controller: 'admin', action: 'currentUsers')}">Current users</a>
                                <a class="btn btn-primary" title="List of all expeditions and their statistics"
