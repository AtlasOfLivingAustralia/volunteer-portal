...
<div class="container">
    ...
    <cl:headerContent title="${message(code: 'default.admin.label', default: 'Admin')}" selectedNavItem="bvpadmin">
        ...
        <div class="span12">
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td>
                        <a class="btn"
                           href="${createLink(controller: 'project', action: 'createNewProject')}">Create New Expedition</a>
                    </td>
                ...
                <tr>
                    <td><a class="btn"
                           href="${createLink(controller: 'picklist', action: 'manage')}">Bulk manage picklists</a></td>
                    <td>Allows modification to the values held in various picklists</td>
                </tr>
                <tr>
                    <td><a class="btn"
                           href="${createLink(controller: 'validationRule', action: 'list')}">Validation Rules</a></td>
                    <td>Manage transcription validation rules</td>
                </tr>
                <tr>
                    <td><a class="btn"
                           href="${createLink(controller: 'frontPage', action: 'edit')}">Configure front page</a></td>
                ...
                <tr>
                    <td><a class="btn"
                           href="${createLink(controller: 'setting', action: 'index')}">Advanced Settings</a></td>
                    <td>Advanced Settings</td>
                </tr>
                <tr>
                    <td>Admin reports</td>
                    <td>
                        <a class="btn" title="Display a list of email address for all volunteers"
                           href="${createLink(controller: 'admin', action: 'mailingList')}">Global mailing List</a>
                        <a class="btn" title="Users and their various counts and last activity etc..."
                           href="${createLink(controller: 'ajax', action: 'userReport', params: [wt: 'csv'])}">User report</a>
                        <a class="btn" title="A summary of recent user activity"
                           href="${createLink(controller: 'admin', action: 'currentUsers')}">Current users</a>
                        <a class="btn" title="List of all expeditions and their statistics"
