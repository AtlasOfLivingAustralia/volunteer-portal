        ...
        <table class="table">
            <tr>
                <td style="padding-top:18px; width:150px;">
                    <img src="http://www.gravatar.com/avatar/${userInstance.email.toLowerCase().encodeAsMD5()}?s=150"
                         style="width:150px;" class="avatar"/>
                    <g:if test="${userInstance.userId == currentUser}">
                        <p>
                            <a href="http://en.gravatar.com/" class="external" target="_blank" id="gravitarLink"
                               title="To customise this avatar, register your email address at gravatar.com...">Change avatar</a>
                        </p>
                    </g:if>
                </td>
                <td>
                    <table style="border: none; margin-top: 8px;">
                        ...
                        <g:if test="${project}">
                            <tr class="prop">
                                ...
                                <td valign="top" class="value">${project.featuredLabel} (<a
                                        href="${createLink(controller: 'user', action: 'show', id: userInstance.id)}">View tasks from all projects</a> )
                                </td>
                            </tr>
                        </g:if>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.score.label"
                                                                     default="Volunteer score"/></td>
                            <td valign="top" class="value">${score}</td>
                        </tr>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.recordsTranscribedCount.label"
                                                                     default="Tasks transcribed"/></td>
                            <td valign="top"
                                class="value">${totalTranscribedTasks} (${validatedCount} of which have been validated)</td>
                        </tr>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.transcribedValidatedCount.label"
                                                                     default="Tasks validated"/></td>
                            <td valign="top" class="value">${userInstance.validatedCount}</td>
                        </tr>
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.created.label"
                                                                     default="First contribution"/></td>
                ...
                <td style="vertical-align: top" align="right">
                    <g:if test="${achievements.size() > 0}">
                        <table class="bvp-expeditions"
                               style="margin:10px; border: 1px solid #d3d3d3;text-align: center; border-collapse: separate;"
                               width="400px">
                            <thead>
                ...
                <td colspan="3">
                    <cl:ifAdmin>
                        <div class="alert alert-info" style="margin-bottom: 0px">
                            <g:link class="btn btn-small" controller="user" action="editRoles"
                                    id="${userInstance.id}">Manage user roles</g:link>
                            <g:link class="btn btn-small" controller="user" action="edit"
    ...
    <div class="span12">
        <div class="tabbable">
            <ul class="nav nav-tabs">
                <li class="${selectedTab == 0 ? 'active' : ''}"><a href="#tabs0" data-toggle="tab"
                                                                   tabIndex="0"><strong>Transcribed Tasks</strong></a>
                </li>
                <li class="${selectedTab == 1 ? 'active' : ''}"><a href="#tabs1" data-toggle="tab"
                                                                   tabIndex="1"><strong>Saved Tasks</strong></a></li>
                <cl:ifValidator>
                    <li class="${selectedTab == 2 ? 'active' : ''}"><a href="#tabs2" data-toggle="tab"
                                                                       tabIndex="2"><strong>Validated Tasks</strong></a>
                    </li>
                </cl:ifValidator>
                <li class="${selectedTab == 3 ? 'active' : ''}"><a href="#tabs3" data-toggle="tab"
                                                                   tabIndex="3"><strong>Forum messages</strong></a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div id="tabs3" class="tab-pane ${selectedTab == 3 ? 'active' : ''}">
                    <g:if test="${selectedTab == 3}">
                        <g:include controller="forum" action="userCommentsFragment"
                                   params="${includeParams + [projectId: project?.id, userId: params.id]}"/>
                    </g:if>
                </div>
            </div>
        </div>
