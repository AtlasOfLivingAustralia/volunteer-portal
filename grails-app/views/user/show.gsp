            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.transcribedCount.label" default="Transcribed Count" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.validatedCount.label" default="Validated Count" /></td>
