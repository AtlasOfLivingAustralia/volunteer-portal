    ...
    <div class="container">
        <ul class="nav nav-tabs profile-tabs" role="tablist" id="profileTabsList">
            <li role="presentation" class="${selectedTab == 0 || !selectedTab ? 'active' : ''}">
                <a href="#transcribed-tasks" content-url="${createLink(controller: 'user', action: 'transcribedTasksFragment', id: userInstance.id, params: includeParams + [projectId: project?.id])}" aria-controls="transcribed-tasks" role="tab" data-toggle="tab">Transcribed Tasks</a>
            </li>
            <li role="presentation" class="${selectedTab == 1 ? 'active' : ''}"><a href="#saved-tasks" content-url="${createLink(controller: 'user', action: 'savedTasksFragment', id: userInstance.id)}" aria-controls="saved-tasks" role="tab" data-toggle="tab">Saved Tasks</a></li>
