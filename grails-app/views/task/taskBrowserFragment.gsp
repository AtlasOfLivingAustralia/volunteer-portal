    ...
    <div id="task_browser_controls">
        ...
        <div>
            <span style="padding: 5px; float: left">
                <button class="btn btn-sm btn-outline-secondary" id="show_prev_task">
                    <i class="fa fa-arrow-left"></i>&nbsp;Previous
                </button>
                <button class="btn btn-sm btn-outline-secondary" id="show_next_task">
            ...
            <span style="padding: 5px;float:right">
                ...
                <button class="btn btn-sm btn-secondary" style="margin-right: 10px" id="search_button">Search</button>
                <button class="btn btn-sm btn-primary" id="copy_task_data">Copy</button>
                <button class="btn btn-sm btn-outline-secondary" id="cancel_button">Cancel</button>
            </span>
        </div>
        <hr/>
    </div>
