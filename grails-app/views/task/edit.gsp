                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="externalUrl"><g:message code="task.externalUrl.label" default="External Url" /></label>
                                </td>
...
<g:link controller="multimedia" action="create" params="['task.id': taskInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'multimedia.label', default: 'Multimedia')])}</g:link>
