            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.fullyTranscribedBy.label" default="Fully Transcribed By" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.fullyValidatedBy.label" default="Fully Validated By" /></td>
