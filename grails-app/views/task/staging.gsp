            ...
            <table class="table table-striped table-bordered">
                    ...
                    <g:each in="${profile.fieldDefinitions.sort({ it.id })}" var="field">
                        <th fieldDefinitionId="${field.id}">
                            <div class="label" style="display: block">
                                <span style="font-weight: normal">${field.fieldDefinitionType} <b>${field.format}</b>
                                </span>

                                <a href="#" class="btnEditField pull-right" title="Edit column definition"><i
                                        class="icon-edit icon-white"></i></a>
                                <g:if test="${field.fieldName != 'externalIdentifier'}">
                                    <a href="#" class="btnDeleteField pull-right" title="Remove column"><i
                ...
                <g:each in="${images}" var="image">
                    <tr>
                                    ...
                                    <g:each in="${image.shadowFiles}" var="shadow">
                                        <li>
                                            <div class="label">
                                                ...
                                                <a href="#" class="btnDeleteShadowFile"
                        ...
                        <td>
                            <button class="btn btn-mini btn-danger btnDeleteImage" imageName="${image.name}"><i
