                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <div class="well well-small">
                            <a class="btn btn-small" href="${createLink(action:'show', id: taskInstance?.id)}">Transcribe/Validate Task</a>
                            <cl:ifAdmin>
                                <a class="btn btn-small btn-warning" href="${createLink(action:'resetTranscribedStatus', id: taskInstance?.id)}">Reset transcribed status</a>
                                <a class="btn btn-small btn-warning" href="${createLink(action:'resetValidatedStatus', id: taskInstance?.id)}">Reset validated status</a>
                            </cl:ifAdmin>
                        </div>
                    </div>
                    <div class="span6">
