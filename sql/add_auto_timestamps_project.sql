...
update project set date_created = COALESCE(date_created, created, CURRENT_TIMESTAMP);
...
alter table project alter column last_updated set default CURRENT_TIMESTAMP;
