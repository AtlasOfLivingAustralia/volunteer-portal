            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.externalIdentifier.label" default="External Identifier" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.fullyTranscribed.label" default="Fully Transcribed" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${taskInstance?.fullyTranscribed}" /></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="task.fullyValidated.label" default="Fully Validated" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${taskInstance?.fullyValidated}" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" style="text-align: left;" class="value">
                                ...
                                <g:each in="${taskInstance.multimedia}" var="m">
                                    <li><g:link controller="multimedia" action="show" id="${m.id}">${m?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
