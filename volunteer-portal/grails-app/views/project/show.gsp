    ...
    <div id="column-two">
      <div class="section">
        ...
        <ul>
          ...
          <li><g:link class="list" action="deleteRecords" controller="project" id="${projectInstance.id}"><g:message code="default.delete.records" default="Delete records"/></g:link></li>
          <li><g:link class="list" action="load" controller="task" id="${projectInstance.id}"><g:message code="default.upload.tasks" default="Upload tasks"/></g:link></li>
        </ul>
      </div>
    </div><!-- column-two -->
    </div>
